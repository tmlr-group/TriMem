...
# LLM Model name
# Examples: "openai/gpt-4.1-mini", "gpt-4.1", "qwen3-max", "qwen-plus-2025-07-28"
...
# Source context window: when fetching source dialogues for answer generation,
# include this many surrounding turns before/after each source dialogue
...
# Enable progressive entity profile building
ENABLE_PROFILES = True

# ProfileStore SQLite path
